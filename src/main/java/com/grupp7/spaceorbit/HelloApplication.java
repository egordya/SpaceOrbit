...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        planteter[0] = new NormalCelestialObject(new Vector2D(0, 0.8), new Vector2D(0.2,0), 10500);
        planteter[1] = new NormalCelestialObject(new Vector2D(0, -1.5), new Vector2D(-0.3, 0), 10000);
